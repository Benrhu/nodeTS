...
let AuthController = class AuthController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user) {
                ...
                yield (0, User_orm_1.registerUser)(user).then((r) => {
                    (0, logger_1.LogSuccess)(`[/api/users] Create User: ${user.email} `);
                    response = {
                ...
                (0, logger_1.LogWarning)('[/api/auth/register] Register needs User');
                response = {
    ...
    loginUser(auth) {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            if (auth) {
                (0, logger_1.LogSuccess)(`[/api/auth/login] Logn User: ${auth.email} `);
